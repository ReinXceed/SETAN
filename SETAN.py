...
def login():
    ...
    try:
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun kena Checkpoint mampus'
            os.system('rm -rf login.txt')
            time.sleep(1)
            keluar()
        else:
            print '\n\x1b[1;91m[!] Login Gagal..yang bener klw login asu'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
...
def menu():
    ...
    try:
        ...
        os.system('clear')
        print '\x1b[1;91m[!] Token tidak ditemukan anjing'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    else:
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mSepertinya akun kena Checkpoint kontol'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
            print '\x1b[1;91m[!] Tidak ada koneksi goblok'
            keluar()
    ...
    print '\x1b[1;37;40m1. ReinXceed mencwrikan informasi Pengguna'
    print '\x1b[1;37;40m2. Hack Akun Facebook                     '
    print '\x1b[1;37;40m3. Bot buatan ReinXceed                   '
...
def informasi():
    ...
    try:
        ...
        print '\x1b[1;91m[!] Gada tokennya anjing'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    id = raw_input('\x1b[1;91m[+] \x1b[1;92mMasukan ID lu\x1b[1;97m/\x1b[1;92mNama\x1b[1;91m : \x1b[1;97m')
    jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar.. yg sabar \x1b[1;97m...')
